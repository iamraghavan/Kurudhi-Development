...
<head>
    ...
    <!-- custom css -->
    <link rel="stylesheet" href="./css/ishulove.css">
    <!-- ---------- -->
...
<body>
    ...
    <main id="content" class="">
        <section style="background-image: url('./images/Images/banner-landing-home.png')"
            class="bg-img-cover-center py-10 pt-md-16 pb-md-17">
            <div class="container position-relative z-index-2 text-center">
                ...
                <div class="mxw-751">
                    <h1 class="text-black-50 fs-30 fs-md-42 lh-15 font-weight-normal mt-4 mb-10"
                        data-animate="fadeInRight">We
                                    ...
                                    <div class="form-right">
                                        <div class="form-checkbox">
                                            <label class="container">
                                                <p>I authorise this website to display my name and telephone number, so
                                                    that the needy could
                                                    contact me, as and when there is an emergency.</p>
